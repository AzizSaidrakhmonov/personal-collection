...
const CabinetCreateCollections = () => {
    ...
    const sendCollection = async (e) => {
        ...
        try {
            const res1 = await axios.post(`http://ec2-54-167-37-126.compute-1.amazonaws.com:8082/api/image/profile/pic`, imageData, {
                headers: {
            ...
            const res2 = await axios.post(
                `http://ec2-54-167-37-126.compute-1.amazonaws.com:8082/api/collection/add/${userId}`,
                {
                    topic: topic,
    ...
    const handleDelete = async (e, id) => {
        console.log(id);
        try {
            const res = await axios.delete(`http://ec2-54-167-37-126.compute-1.amazonaws.com:8082/api/collection/delete/${userId}/${id}`, {
                headers: {
                    Authorization: accessToken,
                },
            });
