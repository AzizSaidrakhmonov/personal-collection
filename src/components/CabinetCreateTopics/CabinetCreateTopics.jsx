...
const CabinetCreateTopics = () => {
    ...
    const sendCreatedTopic = async (e) => {
        ...
        try {
            const res = await axios.post(
                'http://ec2-54-167-37-126.compute-1.amazonaws.com:8082/api/topic/add',
                {
                    name: name.value,
                },
                {
    ...
    const handleDelete = async (e, id) => {
        console.log(id);
        try {
            const res = await axios.delete(`http://ec2-54-167-37-126.compute-1.amazonaws.com:8082/api/topic/delete/${id}`, {
                headers: {
                    Authorization: accessToken,
                },
            });
